...
/**
 * Normalizes an interval string to minutes
 ...
 */
export const normalizeIntervalToMinutes = (interval: string): number => {
  ...
  return SUPPORTED_INTERVALS[normalizedInterval].minutes;
};
 ...
 */
export const getIntervalConfig = (interval: string): { profit: number; validityHours: number } => {
  ...
  return {
    ...
    validityHours: SUPPORTED_INTERVALS[normalizedInterval as SupportedInterval].validityHours,
  };
}; 